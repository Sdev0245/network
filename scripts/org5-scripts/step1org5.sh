...
. scripts/org5-scripts/envVarCLI.sh
...
echo
echo "========= Creating config transaction to add org5 to network =========== "
echo
...
echo
echo "========= Config transaction to add org5 to network created ===== "
echo
...
echo
echo "========= Config transaction to add org5 to network submitted! =========== "
echo
